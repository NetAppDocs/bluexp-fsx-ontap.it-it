...
.Capacità automatica
--
Per l'abilitazione sono necessarie le seguenti autorizzazioni aggiuntive link:../use/task-manage-fsx-working-environment.html["gestione automatica della capacità"].
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-accounts-aws.html["Credenziali e autorizzazioni AWS"^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html["Gestione delle credenziali AWS per BlueXP"^]
